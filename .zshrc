...
# remove comment if you wanna auto start tmux on terminal open
# NOTE: for WSL users sometimes might found problem with if working on Remote 
if [[ ! $TERM =~ screen ]]; then
    exec tmux
fi
...
export ZSH="/home/tikno/.oh-my-zsh"
